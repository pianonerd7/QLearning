...
/**
 *
 * I've provided you with a simple Position class with some helper methods. Use
 * this for any place you need to track a location. If you need modify the
 * methods and add new ones. If you make changes add a note here about what was
 * changed and why.
 *
 * This class is immutable, meaning any changes creates an entirely separate
 * copy.
 */
public class Position {
	...
	/**
	 * Returns a list of adjacent positions. This method does not check if the
	 * positions are valid. So it may return locations outside of the map bounds
	 * or positions that are occupied by other objects.
	 *
	...
	/**
	 * Check if the position is within the map. Does not check if the position
	 * is occupied
	 *
	 * @param xExtent
	 *            X dimension size of the map (get this from the StateView
	 *            object)
	 * @param yExtent
	 *            Y dimension size of the map (get this from the StateView
	 *            object)
	...
	/**
	 * Calculates the Euclidean distance between this position and another. May
	 * be useful for your heuristic.
	 *
	 * @param position
	 *            Other position to get distance to
	...
	/**
	 * Calculates the Chebyshev distance between this position and another. May
	 * be useful for your heuristic.
	 *
	 * @param position
	 *            Other position to get distance to
	...
	/**
	 * True if the specified position can be reached in one step. Does not check
	 * if the position is in bounds.
	 *
	 * @param position
	 *            Position to check for adjacency
	...
	/**
	 * Utility function. Allows you to check equality with pos1.equals(pos2)
	 * instead of manually checking if x and y are the same.
	 *
	 * @param o
	 *            Position to check equality with
